import { Wrench, Users, Car, FileText, Calendar, Box, Activity, Settings, MessageSquare, Shield, BarChart3, Search, Bell, LogOut, LayoutDashboard, Plus, CreditCard, GraduationCap, Briefcase, UserRound, ClipboardList, Receipt, Smartphone, Image, UserCheck, QrCode } from "lucide-react";
