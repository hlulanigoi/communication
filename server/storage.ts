...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const sampleSuppliers: Supplier[] = [
      {
        ...
        paymentTerms: "Net 30",
        rating: "4.5",
        notes: "Reliable supplier for OEM parts",
        status: "Active",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        city: "Chicago",
        country: "USA",
        website: "https://premiumautosupply.com",
        paymentTerms: "Net 15",
        rating: "4.8",
        notes: "Best for performance parts",
        status: "Active",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ...
    const supplier2 = sampleSuppliers[1];
    ...
    const sampleInventoryItems: InventoryItem[] = [
      {
        ...
        status: "Active",
        isLowStock: "false",
        tags: JSON.stringify(["brake", "front", "ceramic"]),
      ...
      },
      {
        ...
        status: "Active",
        isLowStock: "false",
        tags: JSON.stringify(["oil", "synthetic", "5w30"]),
        images: JSON.stringify([]),
        warranty: null,
      ...
      },
      {
        ...
        status: "Active",
        isLowStock: "true",
        tags: JSON.stringify(["filter", "oil"]),
        images: JSON.stringify([]),
        warranty: null,
      ...
      },
      {
        ...
        status: "Active",
        isLowStock: "false",
        tags: JSON.stringify(["spark plug", "iridium", "ignition"]),
        images: JSON.stringify([]),
        warranty: "2 years",
      ...
      },
      {
        ...
        description: "Standard air filter for most sedans",
        category: "Filters",
        ...
        status: "Active",
        isLowStock: "false",
        tags: JSON.stringify(["filter", "air"]),
        images: JSON.stringify([]),
        warranty: null,
        notes: null,
        createdAt: new Date(),
      ...
      },
      {
        ...
        description: "Pre-mixed coolant/antifreeze 50/50",
        category: "Fluids",
        subcategory: "Coolant",
        stock: "32",
        minStock: "15",
        ...
        status: "Active",
        isLowStock: "false",
        tags: JSON.stringify(["coolant", "antifreeze", "fluid"]),
        images: JSON.stringify([]),
        warranty: null,
        notes: null,
        createdAt: new Date(),
